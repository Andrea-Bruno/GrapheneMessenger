...
val canonicalVersionName = "25.10.26" // alias: "7.61.3"
...
android {
  ...
  productFlavors {
    create("store") {
      ...
      buildConfigField("boolean", "MANAGES_GRAPHENE_UPDATES", "false")
    }

    create("website") {
      dimension = "distribution"
      isDefault = true
      buildConfigField("boolean", "MANAGES_GRAPHENE_UPDATES", "true")
    }
