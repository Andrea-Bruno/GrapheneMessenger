...
val canonicalVersionCode = 260120 // alias: 1633
val canonicalVersionName = "26.01.20" // alias: "7.68.5"
  ...
  androidComponents {
    beforeVariants { variant ->
      ...
      if (isSelected && matchesBuild) {
        // GRAPHENE: Disable unit tests for non-debug builds
...
dependencies {
  ...
  implementation(libs.graphene.ringrtc)
