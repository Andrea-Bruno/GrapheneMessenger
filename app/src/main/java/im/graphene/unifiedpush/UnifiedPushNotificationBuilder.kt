...
class UnifiedPushNotificationBuilder(val context: Context) {
  ...
  fun setNotificationDeviceLimitExceeded(deviceLimit: Int) {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__graphenesocket_device_limit_hit, deviceLimit - 1))
  }


  fun setNotificationGrapheneSocketForbiddenEndpoint() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__graphenesocket_forbidden_endpoint))
  }

  fun setNotificationGrapheneSocketForbiddenUuid() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__graphenesocket_forbidden_uuid))
  }

  fun setNotificationGrapheneSocketForbiddenPassword() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__graphenesocket_forbidden_password))
  }
