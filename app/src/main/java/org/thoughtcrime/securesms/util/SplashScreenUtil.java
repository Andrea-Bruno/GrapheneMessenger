...
public final class SplashScreenUtil {
  ...
  public static void setSplashScreenThemeIfNecessary(@Nullable Activity activity, @NonNull SettingsValues.Theme theme, boolean useDynamicColors) {
    ...
    switch (theme) {
      case LIGHT:
        activity.getSplashScreen().setSplashScreenTheme(R.style.Theme_Graphene_Starting_Light);
        break;
      case DARK:
        activity.getSplashScreen().setSplashScreenTheme(R.style.Theme_Graphene_Starting_Dark);
        break;
      case SYSTEM:
