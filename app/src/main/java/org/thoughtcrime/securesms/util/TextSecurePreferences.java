...
public class TextSecurePreferences {
  ...
  private static final String[] booleanPreferencesToBackupGraphene = {
      LOG_ENABLED,
      UPDATE_APK_ENABLED,
  ...
  private static final String[] stringSetPreferencesToBackupGraphene = {PASSPHRASE_LOCK_TRIGGER};

  private static final String[] integerPreferencesToBackupGraphene = {PASSPHRASE_LOCK_TIMEOUT};
  ...
  public static long getPreferencesToSaveToBackupCount(@NonNull Context context) {
    ...
    for (String booleanPreference : booleanPreferencesToBackupGraphene) {
      if (preferences.contains(booleanPreference)) {
        count++;
      }
    }

    for (String stringSetPreference : stringSetPreferencesToBackupGraphene) {
      if (preferences.contains(stringSetPreference)) {
        count++;
      }
    }

    for (String integerPreference : integerPreferencesToBackupGraphene) {
  ...
  public static int getLastVersionCodeForGraphene(Context context) {
    return getIntegerPreference(context, LAST_VERSION_CODE_PREF, BuildConfig.VERSION_CODE);
  }

  public static void setLastVersionCodeForGraphene(Context context, int versionCode) {
