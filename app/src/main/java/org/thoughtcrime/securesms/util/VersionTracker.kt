...
object VersionTracker {
  ...
  @JvmStatic
  fun getLastSeenVersionForGraphene(context: Context): Int {
    return TextSecurePreferences.getLastVersionCodeForGraphene(context)
  }

  @JvmStatic
  fun updateLastSeenVersion(context: Context) {
    val currentVersionCode = BuildConfig.VERSION_CODE
    val lastVersionCode = TextSecurePreferences.getLastVersionCodeForGraphene(context)
    ...
    TextSecurePreferences.setLastVersionCodeForGraphene(context, currentVersionCode)
  }
