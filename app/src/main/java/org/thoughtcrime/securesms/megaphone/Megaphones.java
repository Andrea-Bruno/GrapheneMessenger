...
public final class Megaphones {
  ...
  private static final Set<Event> DONATE_EVENTS                      = SetUtil.newHashSet(Event.DONATE_GRAPHENE);
  ...
  private static @NonNull Megaphone buildEnableAppUpdatesMegaphone(@NonNull Context context) {
    return new Megaphone.Builder(Event.ENABLE_APP_UPDATES, Megaphone.Style.BASIC)
        ...
        .setBody(R.string.EnableAppUpdatesMegaphone_graphene_can_periodically_check_for_new_releases_and_ask_you_to_install_them)
  ...
  private static @NonNull Megaphone buildDonateQ2Megaphone(@NonNull Context context) {
    return new Megaphone.Builder(Event.DONATE_GRAPHENE, Megaphone.Style.BASIC)
        .setTitle(R.string.DonateMegaphone_graphene_is_free_software)
        .setBody(R.string.DonateMegaphone_we_maintain_graphene_with_your_support_consider_donating_at_open_collective)
  ...
  public enum Event {
    ...
    ENABLE_APP_UPDATES("enable_app_updates_graphene"),
    DONATE_GRAPHENE("donate_graphene"),
