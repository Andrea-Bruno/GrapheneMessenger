...
public class ApplicationMigrations {
  ...
  static final class Version {
    ...
    //static final int PNI_IDENTITY_2              = 57; // GRAPHENE: Skipped migration
    ...
    static final int STORY_VIEWED_STATE            = 68; // GRAPHENE: Stories enabled here
...
//    static final int DECRYPTIONS_DRAINED           = 80;
    ...
    //static final int DEDUPE_DB_MIGRATION         = 88; // GRAPHENE: Skipped migration
    ...
    //static final int RECHECK_PAYMENTS            = 96; // GRAPHENE: No payments
...
//    static final int FIX_INACTIVE_GROUPS           = 127;
    ...
    //static final int RESET_ARCHIVE_TIER          = 144; // GRAPHENE: Unneeded migration
    ...
    //static final int COLLAPSED_EVENTS            = 155; // GRAPHENE: Rerun fixed job at 156
  ...
  public static void onApplicationCreate(@NonNull Context context, @NonNull JobManager jobManager) {
    if (isLegacyUpdate(context)) {
      Log.i(TAG, "Detected the need for a legacy update. Last seen canonical version: " + VersionTracker.getLastSeenVersionForGraphene(context));
...
//    }
    ...
    // // GRAPHENE: Previous job failed because KBS_ENCLAVE had pre-migration values due to a bad merge
