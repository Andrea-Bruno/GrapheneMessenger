  ...
  private fun getConfiguration(state: PrivacySettingsState): DSLConfiguration {
    return configure {
      ...
      switchPref(
        ...
        summary = DSLSettingsText.from(R.string.preferences__protect_graphene_database_with_a_passphrase),
      ...
      switchPref(
        ...
        summary = DSLSettingsText.from(R.string.PrivacySettingsFragment__lock_graphene_access_with_fingerprint_or_face_recognition),
