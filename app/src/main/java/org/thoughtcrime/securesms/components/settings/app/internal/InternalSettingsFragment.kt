  ...
  private fun getConfiguration(state: InternalSettingsState): DSLConfiguration {
    return configure {
      ...
      clickPref(
        ...
        summary = DSLSettingsText.from("Make as Graphene never received the ping from GrapheneSocket. Will cause UnifiedPush to stop and Websocket to restart."),
        onClick = {
          MaterialAlertDialogBuilder(requireContext())
      ...
      clickPref(
        ...
        onClick = {
          ...
          MegaphoneDatabase.getInstance(AppDependencies.application).let {
            ...
            it.markFirstVisible(Megaphones.Event.DONATE_GRAPHENE, System.currentTimeMillis() - TimeUnit.DAYS.toMillis(31))
          }
