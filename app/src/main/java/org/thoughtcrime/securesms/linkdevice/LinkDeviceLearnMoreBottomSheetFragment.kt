...
fun LearnMoreSheet() {
  ...
  val fullString = stringResource(id = R.string.LinkDeviceFragment__for_android_devices_visit_s_to_install_graphene, linkText)
  ...
  return Column(
    ...
    Text(
      ...
      text = stringResource(R.string.LinkDeviceFragment__graphene_on_another_device),
    ...
    LinkedDeviceInformationRow(
      ...
      stringResource(R.string.LinkDeviceFragment__graphene_supports_linking_to_other_android_devices)
    )
