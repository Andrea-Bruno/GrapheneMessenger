...
public final class SettingsValues extends SignalStoreValues {
  ...
  private static final String GRAPHENE_NOTIFICATION_METHOD               = "graphene.notificationMethod";
  ...
  void onFirstEverAppLaunch() {
    ...
    // GRAPHENE: These settings are saved in shared prefs too. Sync with the stored values.
  ...
  public void setTheme(@NonNull Theme theme, boolean useDynamicColors) {
    ...
    // GRAPHENE: Store the value unencrypted to be able to read it back when app is locked
  ...
  public void setLanguage(@NonNull String language) {
    // GRAPHENE: Keep language setting in SharedPreferences
  ...
  public NotificationDeliveryMethod getPreferredNotificationMethod() {
    ...
    if (getStore().containsKey(GRAPHENE_NOTIFICATION_METHOD)) {
      method = NotificationDeliveryMethod.deserialize(
          getString(GRAPHENE_NOTIFICATION_METHOD, NotificationDeliveryMethod.FCM.serialize())
      );
    } else {
  ...
  public void setPreferredNotificationMethod(NotificationDeliveryMethod method) {
    putString(GRAPHENE_NOTIFICATION_METHOD, method.serialize());
  }
