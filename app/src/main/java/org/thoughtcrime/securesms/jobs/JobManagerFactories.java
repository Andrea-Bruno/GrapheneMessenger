...
public final class JobManagerFactories {
  ...
  public static Map<String, Job.Factory> getJobFactories(@NonNull Application application) {
    return new HashMap<>() {{
      ...
      put("AllDataSyncRequestJob",                     new FailingJob.Factory()); // GRAPHENE
      ...
      put("CallQualitySurveySubmission",               new FailingJob.Factory()); // GRAPHENE
      ...
      put(UnifiedPushRefreshJob.KEY,                   new UnifiedPushRefreshJob.Factory());  // GRAPHENE
      ...
      put("InAppPaymentGiftSendJob",                   new FailingJob.Factory()); // GRAPHENE
      ...
      put("MultiDeviceOutgoingPaymentSyncJob",         new FailingJob.Factory()); // GRAPHENE
      ...
      put("PaymentLedgerUpdateJob",                    new FailingJob.Factory()); // GRAPHENE
      put("PaymentNotificationSendJob",                new FailingJob.Factory()); // GRAPHENE
      put("PaymentNotificationSendJobV2",              new FailingJob.Factory()); // GRAPHENE
      put("PaymentSendJob",                            new FailingJob.Factory()); // GRAPHENE
      put("PaymentTransactionCheckJob",                new FailingJob.Factory()); // GRAPHENE
      ...
      put("SendPaymentsActivatedJob",                  new FailingJob.Factory()); // GRAPHENE
      ...
      put("AvatarMigrationJob",                           new FailingJob.Factory());  // GRAPHENE
      ...
      put("CachedAttachmentsMigrationJob",                new FailingJob.Factory());  // GRAPHENE
      ...
      put("LegacyMigrationJob",                           new FailingJob.Factory());  // GRAPHENE
      ...
      put("RecheckPaymentsMigrationJob",                  new FailingJob.Factory());  // GRAPHENE
      put("RecipientSearchMigrationJob",                  new FailingJob.Factory());  // GRAPHENE
      put("ResetArchiveTierMigrationJob",                 new FailingJob.Factory());  // GRAPHENE
      put(SelfRegisteredStateMigrationJob.KEY,            new SelfRegisteredStateMigrationJob.Factory());
      put("StickerLaunchMigrationJob",                    new FailingJob.Factory());  // GRAPHENE
      ...
      put("UuidMigrationJob",                             new FailingJob.Factory());  // GRAPHENE
