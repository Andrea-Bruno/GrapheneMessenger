...
buildscript {
  ...
  dependencies {
    ...
    // GRAPHENE: wire-handler factory now in buildSrc, no manual classpath needed
...
subprojects {
  // GRAPHENE: Limit concurrency of high-RAM tasks to avoid OOMs (especially in CI).
  ...
  // GRAPHENE: Add task `./gradlew allDeps` to list all dependencies for each configuration
